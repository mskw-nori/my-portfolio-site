...
export const GitIcon: FC<SvgIconProps> = props => (
  <MySvg xmlns="http://www.w3.org/2000/svg" viewBox="31.98258924 32.28452272 135.54499681 132.49547728" {...props}>
    <path
      ...
      style={{ fill: '#ff8080' }}
    />
    <path d="m89.74 105.53-27.36 27.36-27.15-26.89a8.49 8.49 0 0 1 .09-11.86l28-28 26.42 26.51a9.12 9.12 0 0 1 0 12.88z" style={{ fill: '#80b3ff' }} />
    <path
