...
export const PinIcon: FC<SvgIconProps> = props => (
  <MySvg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" x="0px" y="0px" viewBox="0 0 92.25 122.88" enableBackground="new 0 0 92.25 122.88" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
